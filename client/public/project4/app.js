...
//parameter1是要控制的對象，parameter2 duration，parameter3 是控制對象的原始狀態 parameter4 是控制對象的動畫結束後的狀態
//控制超人javascript去秀動畫
time_line
...
//選擇select內的option之後，要改變內部的顏色跟計算GPA
...
function setGPA() {
  ...
  let credits = document.querySelectorAll("input.class-credit");
...
addButton.addEventListener("click", () => {
  ...
  document.querySelector("div.allInputs").appendChild(newForm);
...
function handleSorting(direction) {
  ...
  console.log("根據objectArray sort", objectArray);
  //根據object array更新網頁
